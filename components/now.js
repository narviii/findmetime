...
export function Now({timeLineState,timeLineView}) {
    ...
    return (
        <div style={{left:left,width:width}} className="left-1/2 disable-select transition-all w-1  absolute  text-center h-10 leading-10  rounded-sm m-1 z-50 bg-red-900   ">
